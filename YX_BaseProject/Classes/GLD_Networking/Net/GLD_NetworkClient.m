...
- (NSURLSessionDataTask *)dataTaskWithPath:(NSString *)path useHttps:(BOOL)useHttps requestType:(gld_networkRequestType)requestType params:(NSDictionary *)params headers:(NSDictionary *)headers completionHandle:(void(^)(NSURLResponse *response,id responseObject,NSError *error))completionHandle{
...
- (NSNumber *)dispatchUploadTaskWithPath:(NSString *)path useHttps:(BOOL)useHttps params:(NSDictionary *)params headers:(NSDictionary *)headers contents:(NSArray<GLD_UploadFile *> *)contents completionHandle:(void (^)(NSURLResponse *response,id responseObject,NSError *error))completionHandle{
    NSMutableArray *taskIdentifier = [NSMutableArray arrayWithObject:@-1];
    NSMutableURLRequest *request = [[GLD_Request shareInstance] generateUploadRequestWithPath:path useHttps:useHttps method:@"POST" params:params headers:headers contents:contents];
...
- (NSNumber *)dispatchTaskWithPath:(NSString *)path useHttps:(BOOL)useHttps requestType:(gld_networkRequestType)requestType params:(NSDictionary *)params headers:(NSDictionary *)headers completionHandle:(void(^)(NSURLResponse *response,id responseObject,NSError *error))completionHandle{
